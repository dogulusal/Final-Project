...
| 6 | 2026-04-08 | Batch-6: 7 Siyaset records (963,1345,1327,1357,1749,1441,1366) + 1 Dunya (1738) verified + manuel_validasyonlar insert | 114 | 23 | 0.674 | 0.043 | 🎯 Support plateau BROKEN: 22→23! STD gate PASSED: std=0.043<0.05. Accuracy slight dip 70.70→69.25 (variance). Next: Hard-negative refinement or accuracy focus. |
